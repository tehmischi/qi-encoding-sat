...
public class PlExample {
    ...
    public static void main(String[] args) throws ParserException, IOException {
        ...
        Disjunction x = new Disjunction();
        d.add(new Proposition("x"), new Proposition("y"), new Proposition("asdf"));
        beliefSet1.add(d);
        beliefSet.add(beliefSet1.toCnf());
        System.out.println(beliefSet + "\n");
        System.out.println("cnf: " + beliefSet.toCnf());
        System.out.println("cnf: " + i.toCnf());
        ...
        List<PlBeliefSet> beliefSets = parser.parseListOfBeliefBases("a || b \n a && !a ##### c => d", "#####");
        System.out.println(beliefSets);
